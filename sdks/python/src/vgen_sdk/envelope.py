"""VGen task payload encryption and RFC 9180 HPKE key envelopes."""
...
def hpke_open(
    ...
    *,
    ...
    try:
        ...
        raise DecryptionError("HPKE ciphertext authentication failed") from exc
...
def encrypt_payload(key: bytes, plaintext: bytes, *, aad: bytes) -> PayloadCiphertext:
    """Encrypt a small task payload with XChaCha20-Poly1305-IETF."""
...
def decrypt_payload(
    ...
    *,
    ...
    """Authenticate and decrypt a VGen small payload."""
...
def task_aad(
    *,
    ...
    """Build canonical AAD for task payloads, task-key wraps, or artifacts."""
...
def workspace_key_aad(
    *,
    ...
    """Build canonical AAD for a recipient-bound Workspace Data Key."""
...
def _task_wrap_info(aad: bytes) -> bytes:
...
def wrap_task_key(
    ...
    *,
    ...
    """HPKE-wrap a Task Data Key for the assigned Worker."""

    _require_bytes("task data key", task_data_key, TASK_DATA_KEY_BYTES)
    return hpke_seal(
        recipient_public_key,
        task_data_key,
        info=_task_wrap_info(aad),
        aad=aad,
    )
...
def unwrap_task_key(
    ...
    *,
    ...
    """Open a Worker Task Data Key envelope."""
...
def wrap_workspace_key(
    ...
    *,
    ...
    """HPKE-wrap a Workspace Data Key for an already authorized recipient."""
...
def wrap_task_key_for_workspace(
    ...
    *,
    ...
    """Create the reader envelope protected by a Workspace Data Key."""
...
def unwrap_task_key_for_workspace(
    ...
    *,
    ...
    """Open a Workspace reader envelope and return its Task Data Key."""
